...
def makeCategorySpreadsheet(urlsWKW):
    #for example:
...
def makeDateSpreadsheet(urlsWKWDate):
        # for example:
        # row1 is name of category
        # each column a-z row 2+ is the urls in category
        workbook = Workbook()
        ...
        for sublist in urlsWKW:
            ...
            while i < len(sublist):
                ...
                i += 1
            columnASCII += 1
        workbook.save(filename="date.xlsx")
...
if __name__ == '__main__':
    ...
    makeCategorySpreadsheet(urlsWKW)
    #makeDateSpreadsheet(urlsWKW)